...
specialCustomField()
function specialCustomField() {

	orgNameFromUserLogged = HelpCenter.user.organizations[0].name;
	orgNameFromSettings = document.getElementById("ska_customer_custom_field").innerHTML;

	var custoFieldID = document.getElementById("ska_custom_field_to_show").innerHTML;
